...
CONFIG_OPTIONS = [
    ...
    click.option("--client_id", default=None, help=_("client_id on Identity Provider")),
    click.option("--client_secret", default=None, help=_("client_secret on Identity Provider")),
    click.option("--token_url", default=None, help=_("URL to reach the Identity Provider")),
